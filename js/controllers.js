...
phonecatControllers.controller('createProductCtrl', function($scope, TemplateService, NavigationService, $routeParams, $location, ngDialog) {
    $scope.template = TemplateService;
    $scope.menutitle = NavigationService.makeactive('Product');
    TemplateService.title = $scope.menutitle;
    TemplateService.submenu = '';
...
phonecatControllers.controller('editProductCtrl', function($scope, TemplateService, NavigationService, $routeParams, $location, ngDialog) {
    $scope.template = TemplateService;
    $scope.menutitle = NavigationService.makeactive('Product');
    TemplateService.title = $scope.menutitle;
    TemplateService.submenu = '';
...
phonecatControllers.controller('createBlocksCtrl', function($scope, TemplateService, NavigationService, $routeParams, $location, ngDialog) {
    $scope.template = TemplateService;
    $scope.menutitle = NavigationService.makeactive('Blocks');
    TemplateService.title = $scope.menutitle;
    TemplateService.submenu = '';
...
phonecatControllers.controller('editBlocksCtrl', function($scope, TemplateService, NavigationService, $routeParams, $location, ngDialog) {
    $scope.template = TemplateService;
    $scope.menutitle = NavigationService.makeactive('Blocks');
    TemplateService.title = $scope.menutitle;
    TemplateService.submenu = '';
